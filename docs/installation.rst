...
The sources for nglpy-cuda can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/maljovec/nglpy_cuda
.. _tarball: https://github.com/maljovec/nglpy_cuda/tarball/master
